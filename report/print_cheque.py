...
class print_check(models.AbstractModel):
    ...
    def amount_word(self, obj, split_word):
        print("amount function called")
        print(split_word)
        print(type(obj))
        print(obj)
        n = "name"

        amount_in_word_list = obj.split(' ')
        print(amount_in_word_list)
        first_line = " ".join(amount_in_word_list[0:5])
        print(first_line)
        second_line = " ".join(amount_in_word_list[5:])
        print(second_line)
